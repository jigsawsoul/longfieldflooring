      ...
      <div class="relative h-full flex items-center justify-center text-center px-4">
        <div class="max-w-3xl">
          <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">
            Transform Your Space with Expert Flooring
          </h1>
          <p class="text-lg md:text-xl text-white mb-6">
            Professional flooring installation and repair services for your home or business
          </p>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="text-center p-6">
            ...
            <p class="text-gray-600">We use only the finest flooring materials from trusted manufacturers.</p>
          </div>
          <div class="text-center p-6">
            <div class="w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-gray-600">Our experienced team ensures perfect installation every time.</p>
          </div>
          <div class="text-center p-6">
            <div class="w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-gray-600">We respect your time and complete projects within agreed timelines.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl mb-8 max-w-2xl mx-auto">
          Contact us today for a free consultation and estimate. We're here to help bring your flooring vision to life.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="tel:07807613063"
